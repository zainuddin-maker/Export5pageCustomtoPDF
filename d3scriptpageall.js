...
var nameoftabledata = "DIPPING TEMPERATURE";
var configuration = [
    {
...
var data_from_thingworx = [
    ...
    {
        dippingtank: "2)  Sodium Hypchlorite 1",
        spec: 0,
        unit: 0,
        testresult: 0,
        adj: 0,
    ...
    {
        dippingtank: "3)  Sodium Hypochlorite 2",
        spec: 0,
        unit: 0,
        testresult: 0,
        adj: 0,
        ...
        [
            {
                ...
                text_align: "left",
                font_weight: "",
                text: "No of CO Critique Form Accomplished",
            },
            {
                order: 10,
                height: "20",
...
var elementold = "testTable" + idRandom;
// makeTable(elementold);

async function converHTMLToCanvas(elementold, file_name) {
...
async function exportpdfnow(width, file_name) {
    ...
    var optionArray = {
        ...
        html2canvas: { scale: 0.9, width: width + 15, dpi: 192 },

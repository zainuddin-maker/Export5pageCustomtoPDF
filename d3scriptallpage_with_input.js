...
async function converHTMLToCanvaspage1(elementold, file_name) {
    ...
    var widhtparent = document.getElementById(elementold).clientWidth
    var heightparent = document.getElementById(elementold).clientHeight
    console.log("widht", widhtparent, "height", heightparent);
    ...
    d3.select("#" + elementold).style(
        "margin-bottom",
        (sizeheightpdfmax - height +5 +1+2 ) + "px"
    );
...
function makeTablepage2(idtable) {
    ...
    var rowheader1 = tbody.append("tr").style("border-right","1px solid #000").style("border-right","1px solid #000");
    for (let i = 0; i < colgroupdata.length; i++) {
        if (i == 0) {
            rowheader1
                .append("td")
            ...
            while (page <= allpage) {
                ...
                if (page == allpage) {
                    ...
                    d3.select("#" + "page" + (page +addpage) +idRandom).style(
                        "margin-bottom",
                        ((sizeheightpdfmax - heightl) + 5 +1+2) + "px"
                    );
...
async function converHTMLToCanvaspage345(  elementold, file_name ,elementchild ,nameoftabledata ,data_from_thingworx ,booleanprint) {
    ...
    if (sizeheightpdf > sizeheightpdfmax) {
        ...
        sisapage = 0
        console.log("page" + "idRandom" )
        console.log("page" + ((page-1)*elementchild.length + 1 +addpage) +idRandom )
        elementchild.forEach((elementelementchild,ielementchild)=>{

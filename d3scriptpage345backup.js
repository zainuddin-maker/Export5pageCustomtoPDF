...
var configuration = [
    ...
    {
        data_shape_column_name: "sodium1",
        header_name: "Sodium 1",
        width: "160",
    },
    {
        data_shape_column_name: "sodium2",
        header_name: "Sodium 2",
        width: "160",
    },
    {
        data_shape_column_name: "rinse1",
        header_name: "Rinse 1",
        width: "160",
    },
    {
        data_shape_column_name: "rinse2",
        header_name: "Rinse 2",
        width: "160",
    },
    {
        data_shape_column_name: "calciumnitrate",
        header_name: "Calcium Nitrate",
        width: "160",
    },
    {
        data_shape_column_name: "timestamp",
    ...
    {
        data_shape_column_name: "timestampx",
        header_name: "Timestampx",
        width: "84",
    },
    {
        data_shape_column_name: "calciumnitratey",
        header_name: "Calcium Nitratey",
        width: "160",
    },
    {
        data_shape_column_name: "timestamp",
        header_name: "TimestampZ",
        width: "84",
    },
];
...
configuration.forEach((element, i) => {
    sum += parseInt(element.width);
    arraytemp.push(element);
    if (sum > 2200 || i == configuration.length - 1) {
        elementchild[countrarray] = arraytemp;
        arraytemp = [];
        sum = 0;
        countrarray += 1;
    } else {
...
function makeTable(idtable, configuration) {
    // code
    var header_column = [];
...
async function converHTMLToCanvas(elementold, file_name) {
    elementchild.forEach((elementelementchild, ielementchild) => {
        console.log("elementelementchild");
        console.log(elementelementchild);
    });
    //
    // var element = $("#"+ elementold)[0];
    makeTable(elementold, elementchild[1]);

    // var element = d3.select("#" + elementold);
    // console.log("element")
    // console.log(element)

    // console.log("converHTMLToCanvas" ,elementold)
    ...
    console.log(
        "sizeheightpdf > sizeheightpdfmax",
        sizeheightpdf,
        sizeheightpdfmax
    );
    ...
    if (sizeheightpdf > sizeheightpdfmax) {
        ...
        while (page <= allpage) {
            ...
            if (page == allpage) {
                makeTable("page" + page + idRandom, elementchild[1]);

TW.IDE.Widgets.Exportpdf5page = function () {
    ...
    this.widgetProperties = function () {
        var properties = {
            name: "Exportpdf5page",
            description: "Exportpdf5page Chart",
            category: ["Common"],
            isExtension: true,
    ...
    this.afterSetProperty = function (name, value) {
        ...
        // if (name === "JSONDashboardinformation") {
        //     const allWidgetProps = this.allWidgetProperties().properties;
        ...
        //     Object.keys(valuenew).forEach((valuex ,i ) => {

        //         //console.log("valuex")
        //         //console.log(valuex)
             
        //         allWidgetProps[valuex] = {
        //             baseType: valuenew[valuex],
        //             isBindingTarget: true,
        //             name: valuex,
        //             type: "property",
        //         };
        ...
        // if (name === "JSONHeaderinformation") {
        //     const allWidgetProps = this.allWidgetProperties().properties;

        //     let valuenew = typeof value == "string" ? JSON.parse(value) :value;
        //     Object.keys(valuenew).forEach((data) => {
        //         allWidgetProps[data] = {
        //             baseType: valuenew[data],
        //             isBindingTarget: true,
        //             name: data,
        //             type: "property",
        //         };
        ...
        try {
            ...
            for (const [key, value] of Object.entries(allWidgetProps)) {
                if (key.includes("Style")) {
                    ...
                    //console.log("key")
                    //console.log(key)
                    if (key === "JSONDashboardinformation") {
                    
                   
                        let valuenew = typeof this.getProperty(key) == "string" ? JSON.parse(this.getProperty(key)) :this.getProperty(key);
                      
            
                        //console.log("valuenew widget")
                        //console.log(valuenew)
            
                        Object.keys(valuenew).forEach((valuex ,i ) => {
            
                            //console.log("valuex widget")
                            //console.log(valuex)
            ...
            console.log("widgetProps idle table");
...
var dds_information = [
    ...
    {
        name: "No of CO Critique Form Accomplished",
        value: "6",
    },
    {
        name: "No of PM Created",
        value: "7",
    },
    {
        name: "No of PM Modified",
        value: "8",
    },
    {
        name: "No of PM Executed",
        value: "9",
    },
];
var loading_schedule = [
    {
        size: "5.5",
        type: "2051A/2051",
        loading_schedule: "1",
...
var plc_reading = [
    {
        station: "Coag Pump Speed",
        spec: "1",
        actual: "2",
    },
    {
        station: "Latex Stirrer Speed (rpm)",
        spec: "3",
        actual: "4",
    },
    {
        station: "Prime Pump Speed (rpm)",
        spec: "5",
        actual: "6",
    },
    {
        station: "Bead Roller Speed (rpm)",
        spec: "7",
        actual: "8",
    },
    {
        station: "Former Drive Speed (rpm)",
        spec: "9",
        actual: "10",
    },
    {
        station: "M.C Speed (meter per min)",
        spec: "1",
        actual: "2",
    },
];

var chemical_mix_rm_number = [
    {
...
//page 2 
var configuration_page2 = [
    {
        data_shape_column_name: "dippingtank",
        header_name: "DIPPING TANK",
       
    },

    {
        data_shape_column_name: "spec",
        header_name: "SPEC",
     
    },
    {
        data_shape_column_name: "unit",
        header_name: "UNIT",
   
    },
    {
        data_shape_column_name: "testresult",
        header_name: "TEST RESULT",
   
    },
    {
        data_shape_column_name: "adj",
        header_name: "ADJ",
   
    },
    {
        data_shape_column_name: "retest",
        header_name: "RETEST",
 
    },
    {
        data_shape_column_name: "adj2",
        header_name: "ADJ",
     
    },
    {
        data_shape_column_name: "retest2",
        header_name: "RETEST",
     
    },
    {
        data_shape_column_name: "sop",
        header_name: "SOP",
   
    },
    {
        data_shape_column_name: "solution",
        header_name: "SOLUTION",
      
    },
    {
        data_shape_column_name: "water",
        header_name: "WATER",
...
var data_from_thingworx_page2_concentration = [
    {
        dippingtank: "1)  Acid",
        spec: "5-30",
        unit: "g/l",
...
var data_from_thingworx_page2_flowmeter = [
    {
        sop :"1",
        solution :"2",
        water :"water"
...
//p input age 3
var data_from_thingworx_latex_information = [
    {
        timestamp: "0",
        acid: 0,
        sodium1: 0,
...
var configuration_latex_information = [
    {
        data_shape_column_name: "timestamp",
        header_name: "Timestamp",
    },

    {
        data_shape_column_name: "acid",
        header_name: "Acid",
    },
    {
        data_shape_column_name: "timestamp",
...
var data_from_thingworx_dipping_temperature= [
    {
        timestamp: "0",
        acid: 0,
        sodium1: 0,
...
var configuration_dipping_temperature = [
    {
        data_shape_column_name: "timestamp",
        header_name: "Timestamp",
...
var data_from_thingworx_downtime = [
    {
        timestamp: "0",
        acid: 0,
        sodium1: 0,
